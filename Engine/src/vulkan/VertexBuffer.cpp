...
namespace Disarray::Vulkan {
	...
	VertexBuffer::VertexBuffer(Ref<Disarray::Device> dev, Ref<Disarray::Swapchain> swapchain, Ref<Disarray::PhysicalDevice> physical_device, const Disarray::VertexBufferProperties& properties)
		: device(dev)
		, props(properties)
	{
