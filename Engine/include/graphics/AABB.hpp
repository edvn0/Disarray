...
public:
	...
	[[nodiscard]] auto max_vector() const { return glm::vec4 { min_max_x.max, min_max_y.max, min_max_z.max, 1.0F }; }
	[[nodiscard]] auto min_vector() const { return glm::vec4 { min_max_x.min, min_max_y.min, min_max_z.min, 1.0F }; }
